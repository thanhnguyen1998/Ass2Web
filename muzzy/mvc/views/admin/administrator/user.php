<div class="ml-md-4 flex-grow-1">
    ...
    <span class="mb-4 btn btn-primary btn-sm" data-toggle="modal" data-target="#adminUserAddModal">Thêm thành viên mới</span>
    <!-- Modal to add user -->
                ...
                <div class="modal-body">
                    <div id="adminUserAddForm">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="adminUserAddForm_fullname">
                        </div>

                        <div class="form-group">
                            <label for="adminUserAddForm_username">Tên đăng nhập</label>
                            <input class="form-control" type="text" id="adminUserAddForm_username">
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="adminUserAddForm_password">Mật khẩu</label>
                                    <input class="form-control" type="password" id="adminUserAddForm_password">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="adminUserAddForm_repeatpassword">Nhập lại mật khẩu</label>
                                    <input class="form-control" type="password" id="adminUserAddForm_repeatpassword">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="adminUserAddForm_phonenumber">
                        </div>
                        <div class="form-group">
                            <label for="adminUserAddForm_address">Địa chỉ</label>
                            <textarea class="form-control" id="adminUserAddForm_address" rows="3"></textarea>
                        </div>
