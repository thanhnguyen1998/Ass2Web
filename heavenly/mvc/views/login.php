      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-login my-5">
          <div class="card-body">
            ...
            <form action="/heavenly/User/Login" method="POST" class="form-login">
              <p style="color:red;">
              ...
              <a href="/heavenly/User/Register" style="text-decoration: none;">
                <button class="btn btn-lg btn-signup btn-block text-uppercase" type="button">Đăng ký tài khoản</button>
              </a>

              <a href="/heavenly/User/ForgotPassWord" class="forgot-pass">Quên mật khẩu</a>
            </form>
          </div>
