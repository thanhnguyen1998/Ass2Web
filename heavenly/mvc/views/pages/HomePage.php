    ...
    <div class="row">
      <div class="col-md-3">
        <div class="sidebar-top">
          <a href="/heavenly/Home" class="item">
            <div class="icon">
          ...
          <a href="/heavenly/Shop" class="item">
            <div class="icon">
          ...
          <a href="/heavenly/Contact" class="item">
            <div class="icon">
          ...
          <a href="/heavenly/About" class="item">
            <div class="icon">
        ...
        <div class="wraper-top-car">
          <div id="top-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              ...
              <div class="carousel-item">
                <img src="/heavenly/public/image/banner4.jpeg" alt="Third slide">
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="container padding">
    <div class="box-title">
      ...
      <a href="/heavenly/Shop">Xem tất cả</a>
    </div>
        ...
        ?>
          <div class="disable-current">
            <div class="wraper-item">
              <div class="deal-item">
                <a href="/heavenly/Shop/ShopDetail/<?php echo $row["idshop"] ?>" class="avatar">
