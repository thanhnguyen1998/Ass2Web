    ...
    <div class="row padding">
      <div class="col-md-4">
        <div class="card" style="box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23); border-radius: 10px;">
          ...
          <div class="card-body">
            <h5 class="card-title text-center">Vũ Khắc Tình</h5>
      ...
      <div class="col-md-4">
        <div class="card" style="box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23); border-radius: 10px;">
          <img class="card-img-top" src="/heavenly/public/image/human.png" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title text-center">Nguyễn Hữu Đức Thành</h5>
      ...
      <div class="col-md-4">
        <div class="card" style="box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23); border-radius: 10px;">
          <img class="card-img-top" src="/heavenly/public/image/human.png" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title text-center">Phạm Hồng Nhật</h5>
